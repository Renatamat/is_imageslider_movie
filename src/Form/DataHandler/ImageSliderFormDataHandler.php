...
class ImageSliderFormDataHandler implements FormDataHandlerInterface
{
    ...
    public function create(array $data): int
    {
        ...
        foreach ($this->languages as $language) {
            ...
            if (!empty($data['image_tablet'][$langId])) {
                $imageSliderLang->setImageTablet($this->uploadFile($data['image_tablet'][$langId]));
            }
    ...
    public function update($id, array $data): int
    {
        ...
        foreach ($this->languages as $language) {
            ...
            if (!empty($data['image_tablet'][$langId])) {
                if ($imageSliderLang->getImageTablet() !== null) {
                    $this->eraseFile($imageSliderLang->getImageTablet());
                }
                $imageSliderLang->setImageTablet($this->uploadFile($data['image_tablet'][$langId]));
            }
