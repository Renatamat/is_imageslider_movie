...
class ImageSliderType extends TranslatorAwareType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ...
            ->add('image_tablet_preview', TranslatableType::class, [
                'type' => ImagePreviewType::class,
                'label' => $this->trans('Image tablet preview', TranslationDomains::TRANSLATION_DOMAIN_ADMIN),
                'locales' => $this->locales,
                'required' => false,
            ])
            ->add('image_tablet', TranslatableFile::class, [
                'type' => FileType::class,
                'label' => $this->trans('Image tablet', TranslationDomains::TRANSLATION_DOMAIN_ADMIN),
                'locales' => $this->locales,
                'options' => [
                    'data_class' => null,
                    'constraints' => $imageConstrains,
