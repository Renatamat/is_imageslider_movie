...
class ImageSliderFormDataProvider implements FormDataProviderInterface
{
    ...
    public function getData($id): array
    {
        ...
        foreach ($imageSlide->getSliderLangs() as $imageSlideLang) {
            ...
            $slideData['image_tablet'][$imageSlideLang->getLang()->getId()] = $imageSlideLang->getImageTablet();
            ...
            $slideData['image_tablet_preview'][$imageSlideLang->getLang()->getId()] = $this->imagesliderImageThumbProvider->getPath($imageSlideLang->getImageTablet()) ?? $this->placeholderImage;
        }
    ...
    public function getDefaultData(): array
    {
        return [
            ...
            'image_tablet_preview' => $this->getImagePreviewPlaceholder(),
            'title' => [],
            'legend' => [],
            'url' => [],
            'description' => [],
